...
class TestIntegration(unittest.TestCase):
    ...
    def test_integration(self):
        ...
        gps_points = [
            self.get_waypoint_list(w, WaypointType.NO_SEARCH, -1) for w in [waypoint_1, waypoint_2, waypoint_3]
        ]

        post_points = [
            self.get_waypoint_list(w, WaypointType.POST, i)
            for w, i in [(waypoint_4, 1), (waypoint_5, 2), (waypoint_6, 3)]
        ]
