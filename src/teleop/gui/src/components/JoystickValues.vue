...
export default {
    ...
    created: function () {
        ...
        this.joystick_sub.subscribe((msg) => {
            ...
            this.joystick_values.left_right = msg.axes[this.joystick_mappings.left_right]
            this.joystick_values.forward_back = msg.axes[this.joystick_mappings.forward_back]
