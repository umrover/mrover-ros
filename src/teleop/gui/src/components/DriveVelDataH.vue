...
<template>
    <div class="wrap">
        ...
        <tr class = "Bold" >
            <th class = "tableElement">position</th>
            <td v-for="motor in motors" class = "tableElement">{{motor.position}} m</td>
        </tr>
        <tr class = "Bold" >
            <th class = "tableElement">velocity</th>
            <td v-for="motor in motors" class = "tableElement">{{motor.velocity}} m/s</td>
        </tr>
        <tr class = "Bold" >
            <th class = "tableElement">effort</th>
            <td v-for="motor in motors" class = "tableElement">{{motor.effort}} Nm</td>
        </tr>
        </thead>
