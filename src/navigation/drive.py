...
default_constants = {"max_driving_effort": 1.0, "min_driving_effort": -1.0, "turning_p": 10.0,
                     "max_turning_effort": 1.0, "min_turning_effort": -1.0, "driving_p": 1.0}
...
class Driver:
    ...
    def _is_complete(self, target_pos: np.ndarray, rover_pose: SE3, completion_thresh: float) -> bool:
        ...
        return target_dist < completion_thresh
    ...
    def get_drive_command(
        ...
        DRIVING_P = constants["driving_p"]å
        ...
        if self._driver_state == self.DriveMode.STOPPED:
            ...
            last_angular_was_inside = self._last_angular_error is not None and abs(self._last_angular_error) < turn_in_place_thresh
