...
class Driver:
    ...
    def get_drive_command(
        ...
        """
        cmd_vel, reached = self.get_intermediate_target_drive_command(
            target_pos, rover_pose, completion_thresh, turn_in_place_thresh
        )
    ...
    def get_intermediate_target_drive_command(
        self, target_pos: np.ndarray, rover_pose: SE3, completion_thresh: float, turn_in_place_thresh: float
    ) -> Tuple[Twist, bool]:
        """
        ...
        return self.get_clear_path_drive_command(curr_target_pos, rover_pose, completion_thresh, turn_in_place_thresh)
