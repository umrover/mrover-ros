...
#define HEATER_N1_Pin GPIO_PIN_14
#define HEATER_N1_GPIO_Port GPIOB
#define HEATER_B1_Pin GPIO_PIN_15
#define HEATER_B1_GPIO_Port GPIOB
#define HEATER_N2_Pin GPIO_PIN_6
#define HEATER_N2_GPIO_Port GPIOC
#define HEATER_B2_Pin GPIO_PIN_8
#define HEATER_B2_GPIO_Port GPIOA
#define HEATER_N2A9_Pin GPIO_PIN_9
#define HEATER_N2A9_GPIO_Port GPIOA
