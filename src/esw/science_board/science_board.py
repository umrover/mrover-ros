...
class ScienceBridge():
    ...
    def __init__(self):
        ...
        """with open(rospy.get_param("/science_config_file"), 'r') as file:
        ...
        #config['led_map']
        self.max_error_count = rospy.get_param("/info/max_error_count")
        #config['info']['max_error_count']
        # Mapping of onboard devices to MOSFET devices
        self.mosfet_dev_map: dict[str, int] = rospy.get_param("/mosfet_device_map")
        #config['mosfet_device_map']
        ...
        self.sleep = rospy.get_param("/info/sleep")
        #config['info']['sleep']
        self.timeout = rospy.get_param("/serial/timeout")
        #config['serial']['timeout']
        self.uart_transmit_msg_len = rospy.get_param("/info/uart_transmit_msg_len")
    ...
    def __enter__(self) -> None:
        ...
        self.ser = serial.Serial(
            ...
            port=rospy.get_param("/serial/port"),
