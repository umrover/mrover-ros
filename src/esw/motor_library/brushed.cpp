...
namespace mrover {
    ...
    void BrushedController::set_desired_throttle(Percent throttle) {
        ...
        m_device.publish_message(m_controller_name, InBoundMessage{ThrottleCommand{.throttle = throttle}});
    }
    ...
    void BrushedController::set_desired_position(Radians position) {
        ...
        m_device.publish_message(m_controller_name, InBoundMessage{PositionCommand{.position = position}});
    }
    ...
    void BrushedController::set_desired_velocity(RadiansPerSecond velocity) {
        ...
        m_device.publish_message(m_controller_name, InBoundMessage{VelocityCommand{.velocity = velocity}});
    }

    void BrushedController::send_configuration() {
        m_device.publish_message(m_controller_name, InBoundMessage{m_config_command});
