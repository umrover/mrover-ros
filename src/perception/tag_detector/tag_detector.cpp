...
namespace mrover {
    auto TagDetector::onInit() -> void {
        ...
        mServiceEnableDetections = mNh.advertiseService("enable_detections", &TagDetector::enableDetectionsCallback, this);
    ...
    auto TagDetector::configCallback(DetectorParamsConfig& config, uint32_t level) -> void {
    ...
    auto TagDetector::enableDetectionsCallback(std_srvs::SetBool::Request& req, std_srvs::SetBool::Response& res) -> bool {
