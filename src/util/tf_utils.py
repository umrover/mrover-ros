...
def gps_to_world(gps_coord: NavSatFix, ref_coord: NavSatFix, frame: str, world_frame: str) \
        -> TransformStamped:
    """
    ...
    :param frame:           The name of the returned transform frame
    :param world_frame:     The name of the reference world frame
    :return:
    """
