...
from mrover.srv._FetchMessageFromPackage import FetchMessageFromPackage, FetchMessageFromPackageResponse, FetchMessageFromPackageRequest
...
class TopicServices():
    ...
    def fetch_messages_for_package_service(self, req: FetchMessageFromPackageRequest) -> FetchMessageFromPackageResponse:
...
def main():
    ...
    ros.Service("topic_services/fetch_messages_from_package", FetchMessageFromPackage, topics.fetch_messages_for_package_service)
    ros.spin()
