...
def handle_change_uv_led_end_effector_state(req: ChangeDeviceStateRequest) -> ChangeDeviceStateResponse:
...
def change_uv_led_end_effector_state_server() -> None:
    ...
    service = rospy.Service('change_uv_led_end_effector_state', ChangeDeviceState,
