...
def handle_change_heater_auto_shut_off_state(req: ChangeDeviceStateRequest) -> ChangeDeviceStateResponse:
...
def change_heater_auto_shut_off_state_server() -> None:
    ...
    service = rospy.Service('change_heater_auto_shut_off_state', ChangeDeviceState,
